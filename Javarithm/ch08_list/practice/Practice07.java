...
public class Practice07 {
    ...
    static class Data {
        ...
        void scanData(String guide, int sw) {
            System.out.println(STR."\{guide}할 데이터를 입력하세요.");
    ...
    public static void main(String[] args) {
        ...
        CircularLinkedList<Data> list = new CircularLinkedList<Data>();
            ...
            switch (menu = SelectMenu()) {
                ...
                case SEARCH_NO :							// 회원번호로 검색
                    ...
                    if (ptr == null)
                        ...
                        System.out.println(STR."검색 성공 : \{ptr}");
                    break;
                ...
                case RETRIEVE : {						// 특정 노드를 출력
                    ...
                    if (ptr == null)
                        ...
                        System.out.println(STR."그 데이터는 \{ptr.toString()}입니다.");
                }
            }
